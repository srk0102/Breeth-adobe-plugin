...
export const audioFormats: string[] = [
  "aac", "aaf", "ac3", "aif", "aiff", "bwf", 
  "m1a", "m2a", "m4a", "mp2", "mp3", "mpa", "wav", "wma"
];

export const videoFormats: string[] = [
  "264", "3g2", "3gp", "3gpp", "avc", "avi", "dif", "dv", 
  "f4v", "mov", "m1s", "m1v", "m2p", "m2t", "m2ts", "m2v", 
  "m4v", "mp4", "mpe", "mpeg", "mpg", "mpg4", "mts", "mxf", 
  "qt", "r3d", "ts", "vob", "wmv"
];

export const imageGifFormats: string[] = [
  "ai", "ari", "asnd", "bmp", "cin", "cine", "crm", "dib", 
  "dng", "dpx", "eps", "exr", "fli", "gif", "icb", "ico", 
  "jfif", "jpe", "jpeg", "jpg", "pct", "pict", "png", "psd", 
  "rle", "sxr", "tga", "tif", "tiff", "vda", "vst", "webp"
];
