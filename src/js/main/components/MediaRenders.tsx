export const VideoRenderer = ({ fileData }: any) => {
  ...
  return (
      <video 
          controls 
          className="h-full w-full object-cover rounded-lg shadow-lg border border-alpha-10"
...
export const ImageRenderer = ({ fileData }: any) => {
  ...
  return (
    <img 
      ...
      className="h-full w-full object-cover rounded-lg shadow-lg border border-alpha-10 transition-transform duration-300 hover:scale-105" 
    />
  );
};
...
export const AudioRenderer = ({ fileData }: any) => {
  ...
  return (
    <div className="flex items-center justify-center h-full w-full bg-brand-gradient rounded-lg border border-alpha-10">
      <div className="bg-black/60 p-6 rounded-lg border border-alpha-20">
